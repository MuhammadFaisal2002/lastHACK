...
// const {
//   NEXT_PUBLIC_SANITY_PROJECT_ID = "45o9g06r", // Sanity project ID
//   NEXT_PUBLIC_SANITY_DATASET = "production", // Sanity dataset (e.g., "production")
//   NEXT_PUBLIC_SANITY_AUTH_TOKEN = "skRCb9GUUMqi17BuOsAzx0vWAliiHUxtkKtveEGeCsHuE5iJeY53fjOvofxyhWqlfGDPvW4zOnFoPVMdEbi9hQRkkFERmhGQOsVy1OIAR4W17w9Qkl265hMkA5ycs8nrn5Q7UqGaP1bvHgjxbi5oiSBjEba2wmuzXNYysN5BYYmIN7VKgi2E",
...
const targetClient = createClient({
  projectId: "45o9g06r", // Your Sanity project ID
  dataset: "production", // Default to "production" if not set
  useCdn: false, // Disable CDN for real-time updates
  apiVersion: "2023-01-01", // Sanity API version
  token: "skRCb9GUUMqi17BuOsAzx0vWAliiHUxtkKtveEGeCsHuE5iJeY53fjOvofxyhWqlfGDPvW4zOnFoPVMdEbi9hQRkkFERmhGQOsVy1OIAR4W17w9Qkl265hMkA5ycs8nrn5Q7UqGaP1bvHgjxbi5oiSBjEba2wmuzXNYysN5BYYmIN7VKgi2E", // API token for authentication
});
...
async function migrateData() {
  ...
  try {
    ...
    const productsResponse = await fetch(`https://giaic-hackathon-template-08.vercel.app/api/products`);
